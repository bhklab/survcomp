...
%\VignetteDepends{survival, ipred, prodlim, survivalROC, SuppDists, grid, rmeta, bootstrap}
%\VignetteSuggests{Hmisc, CPE, clinfun, survJamda, Biobase}
...
<<survivalCurveAllDatasets,fig=TRUE,pdf=FALSE,eps=TRUE>>==
